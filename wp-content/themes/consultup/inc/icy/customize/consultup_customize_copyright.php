...
function consultup_footer_copyright( $wp_customize ) {
    ...
    $wp_customize->selective_refresh->add_partial('consultup_footer_fb_link', array(
                'selector'        => '.ti-social',
                'render_callback' => 'consultup_customize_partial_consultup_footer_fb_link',
        ));
    }
...
function consultup_customize_partial_consultup_footer_fb_link() {
    return get_theme_mod( 'consultup_footer_fb_link' );
}